        ...
        <>
          ...
          >
            ...
            >
              ...
              >
                <CitrusIcon className="h-6 w-6 text-yellow-500" />
                Little Lemon
              </Link>
              ...
              <div
                className={`${styles.button2} grid w-full grid-cols-2 justify-items-end gap-2 text-sm font-semibold`}
              >
                <Link to={"/sign-up"}>
                  <motion.button
                    whileHover={{ scale: 1.03 }}
                    className={`w-24 justify-self-end rounded-md border border-black px-2 py-2 text-sm text-black hover:bg-slate-100`}
                  >
                    Sign Up
                  </motion.button>
                </Link>
                <Link to={"/log-in"}>
                  <motion.button
                    ...
                    className={`w-24 justify-self-end rounded-md bg-black px-2 py-2 text-white`}
                  >
                    Log In
                  </motion.button>
                </Link>
